...
class WizardExportScenario(models.TransientModel):
    ...
    def action_export(self):
        ...
        for scenario in self.scenario_ids.with_context(active_test=False, lang="en_US"):
            ...
            for step in sorted_steps:
                ...
                if step_xml_id in step_xmlid_counters:
                    ...
                    step_xmlid_counters[step_xml_id] = 1
                    # This prevents problems with 2 steps named 'test'
                    # [generating 'test' and 'test_2']
                    # and a third step named 'test_2' [with this code, it
            ...
            for transition in sorted_transitions:
                ...
                if self.is_copy or not transition_xml_id:
                    transition_xml_id = "scenario_transition_{}_{}".format(
                        normalize_name(scenario.name), normalize_name(transition.name),
                    )
        ...
        action = {
            ...
            "url": "web/content/wizard.export.scenario/{id}/"
            "zip_file/{filename}?download=true".format(
