...
connection_group.add_argument(
    "--host", dest="host", default="localhost", help="Address of the Odoo server."
)
connection_group.add_argument(
    "-p", "--port", dest="port", default="8069", help="Port of the Odoo server."
)
connection_group.add_argument(
    "-d",
    "--database",
...
connection_group.add_argument(
    "-u", "--user", dest="user", default="admin", help="User to export the scenario."
)
connection_group.add_argument(
    "-w", "--password", dest="password", default="admin", help="Password of the user."
)
...
export_group.add_argument(
    "-n", "--name", dest="name", help="Name of the scenario to export."
)
export_group.add_argument(
    "--directory",
    dest="directory",
...
try:
    ...
    connection.login(options.database, login=options.user, password=options.password)
...
for step in sorted_steps:
    ...
    with open("{}/{}.py".format(options.directory, python_filename), "w") as step_file:
