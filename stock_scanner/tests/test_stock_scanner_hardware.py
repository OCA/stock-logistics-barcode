...
class TestStockScannerHardware(common.TransactionCase):
    ...
    def test_no_back(self):
        ...
        scanner_hardware.scanner_call(
            self.hardware.code, action="action", message=scenario_step_types.name
        )
    ...
    def test_legacy_shortcuts(self):
        ...
        self.assertEqual(self.hardware.json_tmp_val2, {"a": "b", "c": [1, 2, 3.5]})
        self.assertEqual(
            self.hardware.tmp_values, {"val2": {"a": "b", "c": [1, 2, 3.5]}}
        )
    ...
    def test_unexisting_tmp_values(self):
        ...
        self.assertFalse(hardware.get_tmp_value("false", default=False), False)
