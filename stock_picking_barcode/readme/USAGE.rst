...
.. image:: /stock_picking_barcode/static/description/stock_picking_scan.png
...
.. image:: /stock_picking_barcode/static/description/scan_successful.png
    :alt: Scan Successful

* Wrong SN:

.. image:: /stock_picking_barcode/static/description/scan_error.png
    :alt: Scan Error

After scanning a product, it will be added to the picking with the corresponding
scanned serial number.

.. image:: /stock_picking_barcode/static/description/stock_picking_result.png
    :alt: Scan Result