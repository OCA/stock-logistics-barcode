...
> ![Inventory barcode action](../static/src/img/inventory_barcode_action.png)
...
> ![Add product](../static/src/img/add_product.png)

\# When you select a product, a numeric field is displayed to add the
quantity.

> ![Add quantity product](../static/src/img/form_add_product_quantity.png)
...
> ![Reset data form](../static/src/img/form_add_product_reset.png)
...
> ![Reset data form](../static/src/img/list_items.png)
...
> ![Reset data form](../static/src/img/list_action_items.png)
...
> ![Apply inventory](../static/src/img/apply_inventory.png)
>
> ![Apply inventory reason](../static/src/img/apply_inventory_reason.png)
...
> ![Operation barcode action](../static/src/img/inventory_barcode_action.png)

\# Select the type of picking. \# The pickings in ready status are
displayed, select the one you want to start scanning.

> ![List picking](../static/src/img/list_picking.png)

1.  Start scanning barcodes.

> ![List picking](../static/src/img/barcode_interface_picking.png)

Actions  
\# All the items that have been configured for the selected picking are
listed.

> ![List picking](../static/src/img/list_items_picking.png)

\# The edit icon in the list allows you to modify the data.

> ![Edit picking](../static/src/img/list_items_picking_edit.png)
...
![Quantity picking](../static/src/img/list_items_picking_quantity.png)
...
![Picking scanned](../static/src/img/list_items_picking_scanned.png)
...
![Picking scanned](../static/src/img/confirm_items_picking.png)
...
![Picking scanned](../static/src/img/confirm_all_quantity_items_picking.png)
