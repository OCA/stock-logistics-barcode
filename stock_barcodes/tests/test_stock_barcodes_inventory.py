...
class TestStockBarcodesInventory(TestStockBarcodes):
    ...
    def setUpClass(cls):
        ...
        cls.stock_inventory_model = cls.env.ref("stock.model_stock_inventory")
        ...
        action = cls.inventory.action_barcode_scan()
        cls.wiz_scan_inventory = cls.ScanReadInventory.browse(action["res_id"])
    ...
    def test_inventory_wizard_scan_product(self):
        """
        Test WizStockBarcodesReadInventory simulating barcode reading
        """
    ...
    def test_inventory_wizard_scan_product_manual_entry(self):
        """
        Test WizStockBarcodesReadInventory in 'manual entry' mode
        """
    ...
    def test_inventory_wizard_scan_product_auto_lot(self):
        """
        Test barcode scan with automatic lot assignment
        """
