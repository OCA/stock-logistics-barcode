...
class TestStockBarcodesGS1Expiry(TestStockBarcodesGS1):
    ...
    def setUpClass(cls):
        ...
        cls.gs1_barcode_01 = "01195011015300001714070410AB-123"
        cls.gs1_barcode_01_use_date = "01195011015300001519070410AB-123"
    ...
    def test_wizard_scan_prueba(self):
        ...
        self.action_barcode_scanned(wiz_inventory, self.gs1_barcode_01)
