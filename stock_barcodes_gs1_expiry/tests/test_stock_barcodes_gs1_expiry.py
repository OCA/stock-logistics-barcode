...
from odoo.addons.stock_barcodes_gs1.tests.\
    test_stock_barcodes_gs1 import TestStockBarcodesGS1
...
class TestStockBarcodesGS1Expiry(TestStockBarcodesGS1):
    ...
    def test_wizard_scan_gs1_expiry_life_date(self):
        ...
        self.assertEqual(self.wiz_scan.lot_id.life_date, '2014-07-04 00:00:00')

    def test_wizard_scan_gs1_expiry_use_date(self):
        self.product_wo_tracking_gs1.tracking = 'lot'
        # Scanning barcode with use date data
        self.action_barcode_scanned(
            self.wiz_scan, self.gs1_barcode_01_use_date)
        self.assertEqual(self.wiz_scan.lot_id.use_date, '2019-07-04 00:00:00')
