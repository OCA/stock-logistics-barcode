...
--- | --- | --- | ---
[barcodes_generator_abstract](barcodes_generator_abstract/) | 16.0.3.0.5 | [![legalsylvain](https://github.com/legalsylvain.png?size=30px)](https://github.com/legalsylvain) | Generate Barcodes for Any Models
